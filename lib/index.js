...
export default class PositionObserver {
  ...
  static #createObserver(target, targetRect, side, observers, self) {
    ...
    if (side === 'top') {
      ...
      options.rootMargin = `0px 0px ${-(this.#vh - top - 2)}px 0px`;
    ...
    if (side === 'left') {
      ...
      options.rootMargin = `0px ${-(this.#vw - left - 2)}px 0px 0px`;
  ...
  #observerCallback(entries, self) {
    ...
    if (this === observers.top) {
      PositionObserver.#vw = rootBounds.width;
    ...
    if (this === observers.right) {
      PositionObserver.#vh = rootBounds.height;
      PositionObserver.#vw = rootBounds.right;
    ...
    if (this === observers.bottom) {
      PositionObserver.#vw = rootBounds.width;
      PositionObserver.#vh = rootBounds.bottom;
