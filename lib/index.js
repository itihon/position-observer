...
export default class PositionObserver {
  ...
  static #unobserve(ctx) {
    console.log('observers unobserve');
  ...
  #observerCallback(entries, self) {
    ...
    if (this === observers.top) console.log('observerCallback top');
    if (this === observers.right) console.log('observerCallback right');
    if (this === observers.bottom) console.log('observerCallback bottom');
    if (this === observers.left) console.log('observerCallback left');

    if (topRecords.length) {
      console.log('observerCallback records top');
    ...
    if (rightRecords.length) {
      console.log('observerCallback records right');
    ...
    if (bottomRecords.length) {
      console.log('observerCallback records bottom');
    ...
    if (leftRecords.length) {
      console.log('observerCallback records left');
    ...
    if (recreationList.size) self.#rafLoops.get(target).start();
  }
